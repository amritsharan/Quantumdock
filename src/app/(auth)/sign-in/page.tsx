          ...
          <Button variant="outline" className="w-full" onClick={handleGoogleSignIn} disabled={isLoading || isGoogleLoading}>
            {isGoogleLoading ? (
                ...
                <svg className="mr-2 h-4 w-4" aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
                    ...
                    <path fill="#34A853" d="M488 261.8l-42.7-34.6C435.9 136.2 348.4 11.8 244 11.8 111.8 11.8 0 123.3 0 261.8s111.8 250 244 250c112.5 0 207-68.4 238.2-162.2L488 261.8z" style={{ "mix-blend-mode": "multiply" }}/>
                    <path fill="#FBBC05" d="M488 261.8c0-21.6-2.5-42.5-7.3-62.6H244v115.3h136.1c-5.4 35.8-21.7 66.7-45.7 87.9l79.5 61.9c52.3-48.4 82.2-118.5 82.2-192.1z" style={{ "mix-blend-mode": "multiply" }}/>
                    <path fill="#EA4335" d="M244 117.1c-62.9 0-116.6 43.1-137.9 101.4l-79.5-61.9C61.4 69.1 146.3 11.8 244 11.8c70.3 0 132.3 28.1 176.9 72.3L344.9 160.4c-28.1-26.6-67.5-42.9-100.9-42.9z" style={{ "mix-blend-mode": "multiply" }}/>
                </svg>
            )}
            Sign in with Google
          </Button>
